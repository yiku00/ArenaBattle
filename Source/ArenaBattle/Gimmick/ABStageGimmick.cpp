...
AABStageGimmick::AABStageGimmick()
{
	...
	StageTrigger->SetCollisionProfileName(CPROFILE_ABTRIGER);
	...
	for (FName GateSocket : GateSockets)
	{
		...
		GateTrigger->SetCollisionProfileName(CPROFILE_ABTRIGER);
...
void AABStageGimmick::SpawnRewardBoxes()
{
	for (const auto& RewardBoxLocation : RewardBoxLocations)
	{
		...
		AABItemBox* RewardBoxActor = GetWorld()->SpawnActorDeferred<AABItemBox>(RewardBoxClass, NewTransform);
		if (RewardBoxActor)
		{
